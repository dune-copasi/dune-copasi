...
// Embedded domain points (rectangle)
Point(1) = {0, 0, 0, lc};
Point(2) = {2, 0, 0, lc};
Point(3) = {2, 1, 0, lc};
Point(4) = {0, 1, 0, lc};

// Embedded domain lines (rectangle)
Line(1) = {1,2};
Line(2) = {2,3};
Line(3) = {3,4};
Line(4) = {4,1};

// Embedded domain points (curve)
Curve Loop(1) = {1,2,3,4};

// Cell and nucleioid points (circle)
...
// Nucleoid lines (circle)
Circle(7) = {6,7,8};
Circle(8) = {8,7,6};

// Nucleoid curve (circle)
Curve Loop(3) = {7,8};

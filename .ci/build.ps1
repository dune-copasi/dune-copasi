...
$modules = @(
  ...
  [pscustomobject]@{ Name = 'dune-multidomaingrid'; Repo = 'https://gitlab.dune-project.org/extensions/dune-multidomaingrid.git'; Branch = 'master' }
  [pscustomobject]@{ Name = 'dune-pdelab'; Repo = 'https://gitlab.dune-project.org/pdelab/dune-pdelab.git'; Branch = 'feature/dune-assembler/main-multithreaded' }
)

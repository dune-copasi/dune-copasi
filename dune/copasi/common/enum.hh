...
//! Policy that setup the grid function spaces including its dependencies in a model
constexpr Stages setup_grid_function_space = Stages::GridFunctionSpace;

//! Policy that setup the coefficient vectors including its dependencies in a model
constexpr Stages setup_coefficient_vector = setup_grid_function_space | Stages::CoefficientVector;

//! Policy that setup the initial condition including its dependencies in a model
constexpr Stages setup_initial_condition = setup_coefficient_vector | Stages::InitialCondition;

//! Policy that setup the constraints including its dependencies in a model
constexpr Stages setup_constraints = setup_coefficient_vector | Stages::Constraints;
...
constexpr Stages setup_grid_operator = setup_local_operator | Stages::GridOperator;

#ifndef DUNE_COPASI_OPERATOR_OPERATOR_HH
#define DUNE_COPASI_OPERATOR_OPERATOR_HH
...
class Operator : public PDELab::PropertyTree
{
public:
   ...
   */
  virtual PDELab::ErrorCondition apply(const Domain& domain, Range& range) = 0;
   ...
   * @return         Value expresssing success/failure of the operation
   */
  virtual PDELab::ErrorCondition apply(Domain& domain, Range& range) {

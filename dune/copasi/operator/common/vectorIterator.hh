...
#ifndef DUNE_COPASI_OPERATOR_COMMON_VECTORITERATOR_HH
#define DUNE_COPASI_OPERATOR_COMMON_VECTORITERATOR_HH
  ...
  namespace PDELab {
    ...
    namespace ISTL {
      ...
      namespace impl {
        ...
        struct _extract_iterators<T,true,Iterators...>
        ...
        template<typename T, typename... Iterators>
        struct _extract_iterators<T,false,Iterators...>
          : public _extract_iterators<typename T::block_type,
                                      false,
        ...
        struct _extract_iterators< Dune::BlockVector<double>,true, Iterators...>
        {
          typedef std::tuple<Iterators...,typename Dune::BlockVector<double>::const_iterator> type;
        };


        template<typename... Iterators>
        struct _extract_iterators<Dune::BlockVector<double>,false,Iterators...>
        {
          typedef std::tuple<Iterators...,typename Dune::BlockVector<double>::iterator> type;
        };


        template<typename V>
        struct extract_iterators
          : public _extract_iterators<V,false>
        {};

        template<typename V>
        struct extract_iterators<const V>
          : public _extract_iterators<V,true>
        {};

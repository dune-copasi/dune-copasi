#ifndef DUNE_COPASI_OPERATOR_ISTL_ADAPTER_HH
#define DUNE_COPASI_OPERATOR_ISTL_ADAPTER_HH
...
namespace Dune::Copasi::ISTL::inline Experimenal {
...
public:
  ...
  virtual PDELab::ErrorCondition apply(Range& range, Domain& domain) override {
    ...
    auto& forward = this->template get<Copasi::Operator<Domain, Range>>("forward");
...
} // namespace Dune::Copasi::inline Experimental::ISTL

#endif // DUNE_COPASI_OPERATOR_ISTL_ADAPTER_HH

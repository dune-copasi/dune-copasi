...
// Refinement value
// refinement = DefineNumber[ 0.5, Name "Parameters/refinement" ];
...
Characteristic Length{ PointsOf{ Volume{3}; } } = 0.2;
Characteristic Length{ PointsOf{ Volume{2}; } } = 0.2;

Physical Volume("Nucleus") = {2};
Physical Volume("Cytoplasm") = {3};
